...
var FullCalendar = function(e) {
    ...
    function b() {
        for (var e; b.__r = a.length; )
            ...
            e.some((function(e) {
                ...
                (a = t.__P) && (n = [],
                (r = f({}, o)).__v = o.__v + 1,
                P(a, o, r, t.__n, void 0 !== a.ownerSVGElement, null != o.__h ? [i] : null, n, null == i ? E(o) : i, o.__h),
                I(n, o),
                o.__e != i && S(o)))
            }
            ))
    ...
    function C(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__e = S,
        p = C; p--; )
            null != b[p] && ("function" == typeof n.type && null != b[p].__e && b[p].__e == n.__d && (n.__d = E(r, p + 1)),
            O(b[p], b[p]));
        if (D)
    ...
    function P(e, t, n, r, o, a, s, l, u) {
        ...
        try {
            e: if ("function" == typeof R) {
                ...
                n.__c ? E = (d = t.__c = n.__c).__ = d.__E : ("prototype"in R && R.prototype.render ? t.__c = d = new R(S,b) : (t.__c = d = new y(S,b),
                d.constructor = R,
                d.render = A),
                D && D.sub(d),
                d.props = S,
                ...
                p)
                    ...
                    if (null == R.getDerivedStateFromProps && S !== h && null != d.componentWillReceiveProps && d.componentWillReceiveProps(S, b),
    ...
    function St(e, t) {
        if (e === t)
            return !0;
        for (var n in e)
            if (ht.call(e, n) && !(n in t))
                return !1;
        for (var n in t)
            if (ht.call(t, n) && e[n] !== t[n])
                return !1;
        return !0
    }
    function Dt(e, t) {
        var n = [];
        for (var r in e)
            ht.call(e, r) && (r in t || n.push(r));
        for (var r in t)
            ht.call(t, r) && e[r] !== t[r] && n.push(r);
        return n
    }
    function bt(e, t, n) {
        if (void 0 === n && (n = {}),
    ...
    function xt(e, t) {
        ...
        return "string" == typeof e ? function(e) {
            ...
            return null
        }(e) : "object" == typeof e && e ? Mt(e) : "number" == typeof e ? Mt(((n = {})[t || "milliseconds"] = e,
        n)) : null
    }
    function Mt(e) {
        var t = {
    ...
    var jt = {
      ...
      , $t = function() {
        function e(e) {
            ...
            for (var o in e)
                o in jt ? (n[o] = e[o],
                r = Math.max(jt[o], r)) : (t[o] = e[o],
                o in Gt && (r = Math.max(Gt[o], r)));
    ...
    function Mn(e, t, n, r, o) {
        ...
        if (u)
            return (c = Nn(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = {
                typeId: u.typeId,
                typeData: u.typeData,
                duration: u.duration
            },
    ...
    function io(e, t) {
        ...
        return no() && "rtl" === n.direction ? u.scrollbarLeft = l : u.scrollbarRight = l,
    ...
    var xo = function(e) {
        ...
        t.prototype.shouldComponentUpdate = function(e, t) {
            return this.debug && console.log(Dt(e, this.props), Dt(t, this.state)),
    ...
    xo.prototype.propEquality = {},
    xo.prototype.stateEquality = {};
    var Mo = function(e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
    ...
    var zo = function(e) {
        ...
        t.prototype.getInnerContent = function() {
            ...
            return void 0 === t && (t = qo(e.defaultContent, e.hookProps)),
            null == t ? null : t
        }
        ,
    ...
    var Jo = function() {
        ...
        e.prototype.buildCurrentRangeInfo = function(e, t) {
            ...
            a = this.buildRangeFromDayCount(e, t, n)) : (a = this.buildCustomVisibleRange(e)) ? i = r.dateEnv.greatestWholeUnit(a.start, a.end).unit : (i = At(o = this.getFallbackDuration()).unit,
        ...
        e.prototype.buildRangeFromDuration = function(e, t, n, r) {
            ...
            return Nt(n) <= 1 && this.isHiddenDay(o) && (o = ot(o = this.skipHiddenDays(o, t))),
            d(),
    ...
    var _i = function() {
        function e(e) {
            ...
            l = o.dateEnv,
            null != (u = s.initialDate) ? l.createMarker(u) : br(s.now, l)), d = a.dateProfileGenerator.build(c);
        ...
        e.prototype.processRawCalendarOptions = function(e, t) {
            var n = pn([an, e, t])
              ...
              , g = !1;
            for (var m in p)
                "plugins" !== m && (p[m] === h[m] || un[m] && m in h && un[m](h[m], p[m]) ? f[m] = v[m] : c[m] ? (f[m] = c[m](p[m]),
                g = !0) : d[m] = h[m]);
    ...
    var ta = function(e) {
      ...
      , aa = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildViewContext = zt(ko),
        ...
        return n(t, e),
        t.prototype.render = function() {
            var e, t = this.props, n = t.toolbarConfig, o = t.options, i = this.buildToolbarProps(t.viewSpec, t.dateProfile, t.dateProfileGenerator, t.currentDate, br(t.options.now, t.dateEnv), t.viewTitle), a = !1, s = "";
    ...
    var ua = function(e) {
        ...
        t.prototype.render = function() {
            ...
            return Yr() || i.push("fc-liquid-hack"),
            e.children(i, o, r, n)
        }
        ,
        t.prototype.componentDidMount = function() {
    ...
    var fa = function(e) {
      ...
      , va = function(e) {
        function t(t, n) {
            ...
            return r.initialNowDate = br(n.options.now, n.dateEnv),
    ...
    var ma = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.createDayHeaderFormatter = zt(ya),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
            ...
            for (var m in u) {
                ...
                for (var w in f) {
                    ...
                    if (zn(E, R.range)) {
                        ...
                        if (!1 === S.overlap)
                            return !1;
                        if (C && !C(new wr(t,p[R.defId],R), new wr(t,D,y)))
                            return !1
                    }
                }
                for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
                    var x = k[T]
                      ...
                      , I = _.instances[m]
                      , N = void 0;
                    if (N = P ? new wr(t,P,I) : new wr(t,D),
                    !x(fr(M, t), N))
                        return !1
                }
            }
    ...
    var ts = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = Bt(es),
    ...
    function ds(e) {
        ...
        return {
            ...
            t.reduce(hs).eventRange.range.end)
        }
    }
    function ps(e) {
    ...
    var xs = function() {
        ...
        e.prototype.handleMove = function(e, t) {
            ...
            !t && Ms(this.movingHit, n) || (this.movingHit = n,
            ...
            for (var i in n) {
                ...
                if (s && s.isWithinClipping(e, t)) {
                    ...
                    if (c >= 0 && c < f && d >= 0 && d < h) {
                        ...
                        v && Bn(v.dateProfile.activeRange, v.dateSpan.range) && (!o || v.layer > o.layer) && (v.componentId = i,
                        v.context = a.context,
                        v.rect.left += l,
                        v.rect.right += l,
                        v.rect.top += u,
      ...
      , Ns = function(e) {
        function t(t) {
            ...
            n.handlePointerUp = function(e) {
                n.dragSelection && (pr(n.dragSelection, e, n.component.context),
                n.dragSelection = null)
            }
            ;
                ...
                if (o.isDragging) {
                    ...
                    if (e) {
                        ...
                        i === a || d.editable && d.droppable ? (s = function(e, t, n) {
                            ...
                            return u
                        }(r, e, a.getCurrentData().pluginHooks.eventDragMutationMassagers)) && (l = vr(n, a.getCurrentData().eventUiBases, s, a),
                        c.mutatedEvents = l,
                        Ca(c, e.dateProfile, a) || (u = !0,
                        s = null,
                        l = null,
                        c.mutatedEvents = {
                            defs: {},
    ...
    var Os = function(e) {
        function t(t) {
            ...
            n.handleHitUpdate = function(e, t, r) {
                ...
                l && (u = vr(i, o.getCurrentData().eventUiBases, l, o),
                d.mutatedEvents = u,
                Ca(d, e.dateProfile, o) || (c = !0,
                l = null,
                u = null,
      ...
      , Ws = function() {
        function e(e, t) {
            ...
            this.handleHitUpdate = function(e, t, o) {
                ...
                (l = !Ca(u, e.dateProfile, a)) && (u.mutatedEvents = {
                    defs: {},
                    instances: {}
                },
                s = null))),
        ...
        function e(e, t) {
            ...
            this.handlePointerDown = function(e) {
                var t = n.dragging
                  ...
                  , o = r.minDistance
                  , i = r.longPressDelay;
                t.minDistance = null != o ? o : e.isTouch ? 0 : an.eventDragMinDistance,
            ...
            if (c)
                for (var h = 0, v = t; h < v.length; h++) {
                    var g = v[h]
                      ...
                      , C = "";
                    D && (l.isRtl ? (C = 0,
                    b = c.lefts[m.lastCol] - c.lefts[m.firstCol]) : (b = 0,
    ...
    var ul = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = zt(Gs),
    ...
    var dl = function(e) {
      ...
      , fl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayTableModel = zt(hl),
            t.headerRef = So(),
            t.tableRef = So(),
            t
        }
            ...
            dayGrid: {
                ...
                dateProfileGeneratorClass: function(e) {
                    ...
                    t.prototype.buildRenderRange = function(t, n, r) {
                        ...
                        (o = i.startOfWeek(l)).valueOf() !== l.valueOf() && (l = Ke(o, 1))),
                        this.props.monthMode && this.props.fixedWeekCount) && (l = Ke(l, 6 - Math.ceil(Qe(s, l))));
                        return {
                            start: s,
                            end: l
                        }
    ...
    var wl = function() {
        ...
        e.prototype.computeTimeTop = function(e) {
            var t, n, r = this.positions, o = this.dateProfile, i = r.els.length, a = (e.milliseconds - Ht(o.slotMinTime)) / Ht(this.slotDuration);
      ...
      , _l = function(e) {
        ...
        t.prototype.updateSizing = function() {
            ...
            n.onCoords && null !== n.clientWidth && (this.rootElRef.current.offsetHeight && n.onCoords(new wl(new po(this.rootElRef.current,(e = this.slatElRefs.currentMap,
      ...
      , Vl = function(e) {
        ...
        t.prototype.renderHiddenGroups = function(e, t) {
            ...
            return yo(Do, null, e.map((function(e) {
                var n, c, d = zl(e.span), p = (n = e.entries,
                c = t,
                n.map((function(e) {
                    return c[e.index]
                }
    ...
    var Bl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = zt(Tl),
        ...
        t.prototype.updateCoords = function() {
            var e, t = this.props;
            t.onColCoords && null !== t.clientWidth && t.onColCoords(new po(this.rootElRef.current,(e = this.cellElRefs.currentMap,
    ...
    var jl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = zt(Gl),
            t.state = {
                slatCoords: null
            },
            t.handleRootEl = function(e) {
    ...
    var $l = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = zt(Jl),
            t.buildSlatMetas = zt(Kl),
            t
        }
        return n(t, e),
        t.prototype.render = function() {
                ...
                return yo("tr", {
                    ...
                    if (!1 !== r.displayEventTime) {
                        var o = e.eventRange.def
                          ...
                          , a = !1
                          , s = void 0;
                        if (o.allDay ? a = !0 : An(e.eventRange.range) ? e.isStart ? s = nr(e, t, n, null, null, i.range.start, e.end) : e.isEnd ? s = nr(e, t, n, null, null, e.start, i.range.end) : a = !0 : s = nr(e, t, n),
                        a) {
                            var l = {
    ...
    var au = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = zt(lu),
    ...
    function lu(e) {
        for (var t = ot(e.renderRange.start), n = e.renderRange.end, r = [], o = []; t < n; )
            r.push(t),
            o.push({
                start: t,
                end: $e(t, 1)
                ...
                if (l) {
                    var u = function(e) {
                      ...
                      , p = function(e, t, n, o) {
                        ...
                        s = o.formatIso(e.end)) : (a = $e(e.start, -1).toISOString(),
    ...
    return Si.push(Bs, vl, Ql, cu, pu, hu),
