    ...
    return (
        <>
            ...
            <div className="main-container card">
                ...
                <img className="comic-img" style={{ maxWidth: "100%" }} src={`/resources/static/img/404-comics/404-${comic}.png?w=2000&h=&fmt=webp`} />

                <div className="display-metropolis valign-wrapper">
                    <img className="inline-logo" src={theme.logo+"?w=800&h=&fmt=webp"} />
                </div>
