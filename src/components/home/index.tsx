            ...
            <div id="main-container">
                ...
                <div id="recent-announcements" className="center-align">
                    <div id="announcements" className="cards-container">
                        <div className="card left-align" style={{ borderColor: "#ffccce" }}>
                            ...
                            <hr />
                            <div className="description markdown-container">
                        ...
                        <div className="card left-align" style={{ borderColor: "#e4ffcc" }}>
                        ...
                        <div className="card hide-on-med-and-down  left-align" style={{ borderColor: "#ffccce" }}>
