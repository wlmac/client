...
export default function Init() {
  mapboxgl.accessToken = "pk.eyJ1IjoibmlraXN1IiwiYSI6ImNrc3A3c2FieTAwM3kybnA3anNjY2c3MXMifQ.T_8vAyTc4PMuGUC23vIOhA";
  ...
  map.on("load", () => {
    map.addSource("floorOne", {
      type: "image",
      url: "../resources/static/core/img/FloorOne.jpg",
      coordinates: [
    ...
    map.addSource("floorTwo", {
      type: "image",
      url: "../resources/static/core/img/FloorTwo.jpg",
      coordinates: [
        [-79.46270547634776, 43.75413886166868], //TL
        [-79.46072668772469, 43.75413886166868], //TR
        [-79.46072668772469, 43.75274955916902], //BR
    ...
    map.addSource("outline", {
      type: "image",
      url: "../resources/static/core/img/booths/booths.jpg",
      coordinates: [
