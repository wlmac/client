...
const Map = () => {
  ...
  const [lng, setLng] = useState(-79.46155348420591);
  const [lat, setLat] = useState(43.753374130758445);
  ...
  useEffect(() => {
    const map = new mapboxgl.Map({
      ...
      style: 'mapbox://styles/nikisu/cktk76xy90rgm17s7q7pg0g55',
      center: [lng, lat],
      zoom: zoom
    });
